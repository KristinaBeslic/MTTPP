...
public class Register {
  ...
  public void testRegister() throws Exception {
    ...
    driver.findElement(By.id("input-firstname")).sendKeys("Martin");
    driver.findElement(By.id("input-lastname")).click();
    driver.findElement(By.id("input-lastname")).clear();
    driver.findElement(By.id("input-lastname")).sendKeys("Martić");
    ...
    driver.findElement(By.id("input-confirm")).sendKeys("martin123");
